    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between border-b bg-white px-6 py-3 shadow-sm">
        <div className="flex items-center gap-4">
          <h1 className="text-lg font-bold text-[#191919]">ED Treatment CMS</h1>
      ...
      <div className="mx-auto max-w-5xl px-6 py-6">
            ...
            <button
              onClick={() => {
                const newBattle: BattleData = {
                  ...
                  features: [
                    { feature: "ED Treatment Access", provider1Value: "", provider2Value: "" },
        ...
        {activeTab === "pages" && (
          <div className="space-y-4">
            <p className="text-xs text-gray-400">Create comparison landing pages (e.g. /best-ed-treatments, /sildenafil). Same layout as the homepage but with custom hero text and provider ranking.</p>
