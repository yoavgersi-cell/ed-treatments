...
export const metadata: Metadata = {
  title: "About ED Treatment - Our Mission, Team & Review Methodology",
  description:
    "Learn how edtreatmenthub.com independently ranks and reviews online erectile-dysfunction treatment providers. Our editorial methodology, review process, medical advisory approach, and commitment to unbiased comparisons.",
  alternates: {
    canonical: "https://www.edtreatmenthub.com/about",
  },
};
...
export default async function AboutPage() {
  ...
  const teamSchema = experts.length > 0 ? {
    ...
    "@type": "Organization",
    name: "edtreatmenthub.com",
    url: "https://www.edtreatmenthub.com",
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-[900px] px-4 py-12 sm:px-6 sm:py-16">
          ...
          <p className="mt-3 max-w-[600px] text-[16px] leading-relaxed text-gray-500">
            We help men make informed decisions about erectile-dysfunction treatment
      ...
      <div className="mx-auto max-w-[900px] px-4 py-10 sm:px-6">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-[16px] leading-[1.75] text-gray-600">
            The online ED treatment market has grown rapidly, with dozens of telehealth providers
            now offering prescription treatments like sildenafil and tadalafil online. For patients,
            this creates a confusing landscape of options with varying pricing, medication quality,
            medical oversight, and support levels.
          </p>
          <p className="text-[16px] leading-[1.75] text-gray-600">
            ED Treatment exists to simplify this decision. We independently research,
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              { icon: Search, title: "Research Providers", desc: "We evaluate every major telehealth ED provider on pricing, treatment options, medical oversight, and patient experience." },
              ...
              { icon: BookOpen, title: "Educate Patients", desc: "Our articles and guides help you understand ED treatments, causes, costs, and what to expect from care." },
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {[
              ...
              { category: "Treatment Access", weight: "20%", desc: "Range of ED treatments offered (sildenafil, tadalafil, and other options), formulations available, and pharmacy quality." },
              { category: "Pricing & Value", weight: "20%", desc: "Total cost including medication, consultations, delivery. Transparency of pricing and absence of hidden fees." },
              { category: "Patient Experience", weight: "15%", desc: "Enrollment process speed, discretion, user interface quality, customer support responsiveness, and delivery reliability." },
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4 text-[16px] leading-[1.75] text-gray-600">
            ...
            <p>
              ...
              discussing ED treatments and their effectiveness.
            </p>
            <p>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4">
              ...
              <div>
                ...
                <p className="text-[12px] text-gray-500">Men compared providers this month</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4">
        ...
        <section className="mb-12">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <p className="text-[15px] leading-[1.75] text-gray-600">
              ED Treatment is not a medical provider and does not prescribe medications.
              The information on this site is for general information and comparison purposes only and
              should not replace professional medical advice. ED treatments are prescription
              medications that require evaluation and supervision by a licensed healthcare provider.
              Always consult with a qualified physician before starting any treatment for erectile
              dysfunction. Individual results vary. Side effects may occur.
            </p>
          </div>
        </section>
