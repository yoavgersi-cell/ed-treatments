...
export const metadata: Metadata = {
  ...
  description:
    "FTC disclosure, affiliate relationship details, medical disclaimer, and revenue model transparency for edtreatmenthub.com.",
  alternates: {
    canonical: "https://www.edtreatmenthub.com/disclaimer",
  },
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-4 text-gray-600 leading-relaxed">
        ...
        <p>
          In accordance with the Federal Trade Commission guidelines, ED Treatment
        ...
        <p>
          ED Treatment participates in affiliate programs with various erectile-dysfunction
        ...
        <p>
          The content on ED Treatment is for general information purposes only and is not
          intended as medical advice. ED treatments are prescription medications that carry
          potential risks and side effects. Always consult with a licensed healthcare
        ...
        <p>
          ED Treatment generates revenue primarily through affiliate commissions.
