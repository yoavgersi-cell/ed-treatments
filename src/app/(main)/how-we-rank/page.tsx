...
const CANONICAL = "https://www.edtreatmenthub.com/how-we-rank";

export const metadata: Metadata = {
  title: "How We Rank & Review ED Treatment Providers - Our Methodology",
  description:
    "Our full methodology for ranking and reviewing online erectile-dysfunction treatment providers: the factors we score, where our data comes from, how we verify accuracy, and how we pick winners in head-to-head comparisons.",
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: "How We Rank & Review ED Treatment Providers - Our Methodology",
    description:
      "The factors we score, where our data comes from, how we verify accuracy, and how we pick winners in our ED treatment provider comparisons.",
    url: CANONICAL,
    type: "article",
  },
};
...
const FACTORS = [
  { category: "Medical Credibility", weight: "25%", desc: "Licensed provider oversight, quality of the medical evaluation, ongoing monitoring, pharmacy standards, and any third-party certifications." },
  { category: "Treatment Access", weight: "20%", desc: "Range of ED treatments offered (sildenafil, tadalafil, and other options), formulations, and dosing flexibility." },
  { category: "Pricing & Value", weight: "20%", desc: "Total cost including medication, consultations, and delivery - plus pricing transparency and the absence of hidden fees." },
  { category: "Patient Experience", weight: "15%", desc: "Enrollment speed, discretion, interface quality, support responsiveness, delivery reliability, and recent verified customer feedback." },
...
const METHOD_FAQS = [
  ...
  },
  {
    ...
    answer:
      "From each provider's published rates with promo conditions applied exactly as published: first-month rates roll to the regular price from month two, plan-locked rates are labeled with their commitment, and per-dose or per-pill pricing is shown on the same basis so plans are genuinely comparable.",
  },
];
...
const SOURCES = [
  ...
  { icon: ShieldCheck, title: "Clinical literature", desc: "Medical claims reference published research on ED and its treatments and FDA prescribing information - not opinion." },
];
...
export default async function HowWeRankPage() {
  ...
  const webPageSchema = {
    ...
    "@type": "WebPage",
    name: "How We Rank & Review ED Treatment Providers - Our Methodology",
    description:
      "Our full methodology for ranking and reviewing online erectile-dysfunction treatment providers: the factors we score, where our data comes from, how we verify accuracy, and how we pick winners.",
    url: CANONICAL,
    publisher: { "@type": "Organization", name: "edtreatmenthub.com", url: "https://www.edtreatmenthub.com" },
  };
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.edtreatmenthub.com" },
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-[900px] px-4 py-12 sm:px-6 sm:py-16">
          ...
          <p className="mt-3 max-w-[640px] text-[16px] leading-relaxed text-gray-500">
            ...
            ED treatment provider, where our information comes from, and how we keep it accurate.
          </p>
      ...
      <div className="mx-auto max-w-[900px] px-4 py-10 sm:px-6">
        ...
        <section className="mb-12">
          ...
          <p className="mb-6 text-[16px] leading-[1.75] text-gray-600">
            ...
            weighting reflects what matters most for safe, affordable, and effective ED treatment.
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 text-[16px] leading-[1.75] text-gray-600">
            ...
            promotion, the condition attached (plan length, first-month rate, per-dose vs. per-pill
        ...
        <section className="mb-12">
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white">
            <div className="divide-y divide-gray-100 text-[14.5px] leading-[1.75] text-gray-600">
              ...
              <p className="p-5"><strong className="text-[#191919]">Medical claims cite primary sources.</strong> Clinical figures reference published research on erectile dysfunction and its treatments and FDA prescribing information, cited on our medical pages - never blog folklore.</p>
        ...
        <section className="mb-12">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <p className="text-[15px] leading-[1.75] text-gray-600">
              edtreatmenthub.com is not a medical provider and does not prescribe medications. The
              information on this site is for general information and comparison purposes only and should
              not replace professional medical advice. ED treatments are prescription medications that
              require evaluation and supervision by a licensed healthcare provider. Always consult a
              qualified physician before starting any treatment for erectile dysfunction. Individual
              results vary.
            </p>
          </div>
        </section>
