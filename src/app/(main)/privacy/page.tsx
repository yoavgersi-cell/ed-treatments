...
export const metadata: Metadata = {
  ...
  description:
    "How ED Treatment (edtreatmenthub.com) collects, uses, and protects your information, including analytics, cookies, and affiliate tracking.",
  alternates: { canonical: "https://www.edtreatmenthub.com/privacy" },
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-4 text-gray-600 leading-relaxed">
        <p>
          This Privacy Policy explains how ED Treatment (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;),
          operating the website edtreatmenthub.com, collects, uses, and shares information when you
          visit our site. ED Treatment is an independent publisher that compares online
          erectile-dysfunction treatment providers; we are not a medical provider and do not sell
          medication.
        </p>
        ...
        <p>
          ...
          <a href="mailto:privacy@edtreatmenthub.com" className="font-semibold text-[#111111] hover:underline">
            privacy@edtreatmenthub.com
          </a>{" "}
          or visit our{" "}
