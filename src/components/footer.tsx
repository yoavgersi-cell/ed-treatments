...
// Single-site ED footer. Category links are absolute site routes. Popular
...
const COLUMNS: { title: string; links: { label: string; href: string }[] }[] = [
  {
    title: "Reviews",
    links: [
      { label: "Quad by MEDVi", href: "/reviews/quad" },
      { label: "Hims", href: "/reviews/hims" },
      { label: "DudeMeds", href: "/reviews/dudemeds" },
      { label: "BraveRX", href: "/reviews/braverx" },
  ...
  },
  {
    title: "Guides",
    links: [
      { label: "What Causes ED", href: "/articles/what-causes-erectile-dysfunction" },
