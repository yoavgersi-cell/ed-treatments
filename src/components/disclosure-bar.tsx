        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setIsOpen(false)}>
          ...
          >
            ...
            <div className="space-y-4 text-[14px] leading-[1.7] text-gray-600">
              <p>
                ED Treatment is an independent comparison website designed to help consumers explore and evaluate erectile-dysfunction treatment providers. We research, review, and compare available programs, services, and treatment options to make the decision process easier.
              </p>
              <p>
