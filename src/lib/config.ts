...
// Single-vertical build: this standalone site is ED only. The array shape is
// kept (the platform types expect it) but holds just the one vertical, served
// at the domain root.
export const VERTICALS: Vertical[] = [
  { id: "ed", name: "ED Treatment", tagline: "Compare the best online erectile-dysfunction treatments", accent: "#111111" },
];

export const DEFAULT_VERTICAL = "ed";
...
export const PUBLISHED_VERTICALS = ["ed"];
