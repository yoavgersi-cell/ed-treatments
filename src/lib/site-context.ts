...
// (edtreatmenthub.com), so there is no hub prefix and no per-vertical branding.
...
const ORIGIN = "https://www.edtreatmenthub.com";
...
export const ROOT_CONTEXT: SiteContext = {
  ...
  origin: ORIGIN,
  canonicalPrefix: "",
  brandDomain: "edtreatmenthub.com",
  brandTeam: "ED Treatment Team",
  noindex: false,
};
